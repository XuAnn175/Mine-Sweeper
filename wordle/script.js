			...
			for(i = 0; i < word.length; i++){
				...
				if(chosenWord.toUpperCase().includes(letter)){
					if(chosenWord[i] === letter){
						if (keyboard.className.includes("Gold") || keyboard.className.includes("Grey")) {
							keyboard.className = keyboard.className.replace(/Gold|Grey/g, "Green");
						}
						else
							keyboard.className += ' blockGreen';
					}
					else{
						if(!keyboard.className.includes("Green"))
